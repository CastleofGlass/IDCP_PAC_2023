...
pdf(paste("10_72425_pyclone/",args,".variant.cluster.ccf.pdf",sep=""), width = 7, height = 7, useDingbats = FALSE, title='')
...
pdf(paste("10_72425_pyclone/",args,".variant.cluster.vaf.pdf",sep=""), width = 7, height = 7, useDingbats = FALSE, title='')
pp <- plot.variant.clusters(result,
                            cluster.col.name = 'cluster',
                            show.cluster.size = FALSE,
                            cluster.size.text.color = 'blue',
...
#### use ccf
pdf(paste("10_72425_pyclone/",args,".cluster.flow.ccf.pdf",sep=""),width = 7,height = 5)
plot.cluster.flow(result, vaf.col.names = ccf_col_name,
                  sample.names = ccf_col_name)
dev.off()

#### use vaf
pdf(paste("10_72425_pyclone/",args,".cluster.flow.vaf.pdf",sep=""),width = 7,height = 5)
...
plot.pairwise(result, col.names = ccf_col_name,
              out.prefix = paste("10_72425_pyclone/",args,".variants.pairwise.plot.ccf",sep="")
)
...
plot.clonal.models(y_vaf,
                   ...
                   out.dir = file.path("10_72425_pyclone/",paste(args,"mono_vaf",sep="_")),
                   out.format = 'pdf',
...
plot.clonal.models(y_ccf,
                   ...
                   disable.cell.frac = FALSE,
                   # output figure parameters
                   out.dir = file.path("10_72425_pyclone",paste(args,"mono_ccf",sep="_")),
                   out.format = 'pdf',
                   overwrite.output = TRUE,width = 12,
                   height = 6,
                   # vector of width scales for each panel from left to right
...
plot.clonal.models(y_vaf,
                   ...
                   disable.cell.frac = FALSE,
                   # output figure parameters
                   out.dir = file.path("10_72425_pyclone/",paste(args,"poly_vaf",sep="_")),
                   out.format = 'pdf',
                   overwrite.output = TRUE,width = 12,
                   height = 6,
                   # vector of width scales for each panel from left to right
...
plot.clonal.models(y_ccf,
                   ...
                   disable.cell.frac = FALSE,
                   # output figure parameters
                   out.dir = file.path("10_72425_pyclone/",paste(args,"poly_ccf",sep="_")),
                   out.format = 'pdf',
                   overwrite.output = TRUE,width = 12,
                   height = 6,
                   # vector of width scales for each panel from left to right
